...
#endif
#if BENCH_TRAIN != 0
#error "This one-button bench is PSD only. Use the separate TRAIN sketch."
#endif
...
// D2 is NOT a separate E-stop in this standalone PSD test.
...
static uint8_t selected = 0; // DIP 16 first, then DIP 15; no motor menu
...
void setup() {
    ...
    Serial.println(F("BENCH PSD ONE BUTTON P4"));
}
void loop() {
